...
var (
	IPFS_PEERS = convertPeers([]string{
		...
		"/ip4/127.0.0.1/tcp/10000/p2p/QmRbuFWa5eH16ysNrsnjhjhDbVz9vmcucUGFBu2xYc63fq",
	})
	//LOCAL_PEER_ENDPOINT = "http://localhost:5001/api/v0/id"
	LOCAL_PEER_ENDPOINT = "/ip4/127.0.0.1/tcp/10000/p2p/QmRbuFWa5eH16ysNrsnjhjhDbVz9vmcucUGFBu2xYc63fq"
)
